...
let url = 'http://localhost:3000/api/cric';
let cat = {paht:'',title:''}
...
describe('test POST api', function(){
    it('post cric to DB', function(done){
        request.post({url:url,form:cric}, function(a,b,c){
            //todo asserts here
            done();
        });
    });
...
describe('test DELETE api', function(){
    it('delete a cric', function(done){
        request.delete({url:url,form:cric}, function(a,b,c){
            //todo asserts here
            done();
        });
    });
